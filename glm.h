...
#define GLM_WIREFRAME (1 << 5)	/* render wireframe model */
#define GLM_TEXTURE2  (1 << 6)	/* draw actual texture */
 ...
 */
  typedef struct _GLMmaterial
  {
    ...
    GLubyte *texture;		/* pointer to the texture map */
    GLint texture_wid;		/* texture width */
    GLint texture_hgt;		/* texture height */
  } GLMmaterial;
